...
import { permissionRequestsTable } from "@infra/db/db.schema.js";
import type { BuiDb } from "@infra/db/db.types.js";
import type { PermissionStore } from "@core/ports/permission-store.types.js";

function nowIso(): string {
  return formatISO(new Date());
}

export function createLibsqlPermissionStore(database: BuiDb): PermissionStore {
  return {
