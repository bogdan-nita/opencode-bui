...
import { createOpenCodeClient } from "@infra/opencode/open-code-client";
import { discoverOpencodeCommands, mergeBridgeCommands } from "@infra/opencode/opencode-commands";
import { createSystemClock } from "@infra/time/system-clock";
import { logger } from "@infra/runtime/logger";
import { createRuntimeDB } from "@infra/db/db";
import { createLibsqlSessionStore } from "@infra/store/libsql-session-store";
import { createLibsqlAgentStore } from "@infra/store/libsql-agent-store";
import { createFileMediaStore } from "@infra/store/file-media-store";
import { createLibsqlPermissionStore } from "@infra/store/libsql-permission-store";
...
import { splitCommand } from "@core/domain/bridge.utils";
import type { RuntimeDependencies } from "./runtime.types";
import { AgentStoreService, ClockService, OpenCodeClientService, SessionStoreService } from "../services";
...
import { writePluginBridgeDiscovery } from "@infra/plugin-bridge/discovery";
import { createPluginBridgeHandler } from "@infra/plugin-bridge/api";
