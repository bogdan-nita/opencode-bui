import type { BridgeAdapter, BridgeRuntimeHandlers, InboundEnvelope, SessionStore, OpenCodeClient, PermissionStore, MediaStore, AgentStore, Clock } from "@bridge/types";
import { bridgeDefinitionById } from "@bridge/registry";
import { conversationKey } from "@core/conversation-router";
import { chooseBacklogMessages, isBacklogMessage } from "@core/backlog-coordinator";
