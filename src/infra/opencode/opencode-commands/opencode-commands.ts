...
import type { BridgeCommandDescriptor } from "@core/ports/bridge-adapter.types";
import type { ConfigDiscovery } from "@infra/config/config";
import { fileExists, readDir } from "@infra/runtime/runtime-fs";
