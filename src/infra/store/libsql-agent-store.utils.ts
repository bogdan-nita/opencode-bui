...
import type { AgentStore } from "@core/ports/agent-store.types.js";
import { agentTemplatesTable } from "@infra/db/db.schema.js";
...
export function createLibsqlAgentStore(database: BuiDb): AgentStore {
  return {
    async list() {
