...
import type { ConversationRef } from "@core/domain/bridge.types";
import { conversationKey } from "@core/application/conversation-router";
import type { SessionMapping, SessionStore } from "@core/ports/session-store.types";
import { conversationSessionsTable, sessionWorkdirsTable } from "@infra/db/db";
